...
namespace VKClient.Common
{
  ...
  {
    public static readonly string API_VERSION = "5.63";
    ...
    public static int[] MOBILE_ONLINE_TYPES = new int[5]
    {
      1,
      2,
      3,
    ...
    public static readonly List<string> SupportedImageExtensions = new List<string>()
    {
      ".JPG",
      ".JPE",
      ".BMP",
    ...
    public static int ResizedImageSize
    {
      get
      {
        return !AppGlobalStateManager.Current.GlobalState.CompressPhotosOnUpload ? 10000000 : 1000000;
      }
    }
    ...
    public static Color AppBarBGColor
    {
      get
      {
        return ((SolidColorBrush) Application.Current.Resources["PhoneAppBarBackgroundBrush"]).Color;
      }
    }
    ...
    public static Color AppBarFGColor
    {
      get
      {
        return ((SolidColorBrush) Application.Current.Resources["PhoneAppBarForegroundBrush"]).Color;
      }
    }
    ...
    public static Color VKColor
    {
      get
      {
        return VKConstants.GetColorFromString("#FF406894");
      }
    }

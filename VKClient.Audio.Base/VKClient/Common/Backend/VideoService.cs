...
namespace VKClient.Common.Backend
{
    ...
    {
        private static readonly Func<string, List<VKClient.Common.Backend.DataObjects.Video>> _deserializeFunc = new Func<string, List<VKClient.Common.Backend.DataObjects.Video>>(jsonStr=>{return JsonConvert.DeserializeObject<GenericRoot<VKList<Video>>>(jsonStr).response.items;});
        ...
        public void AddRemoveToAlbums(long videoId, long ownerId, long targetId, List<long> addToAlbumsIds, List<long> removeFromAlbumsIds, Action<BackendResult<ResponseWithId, ResultCode>> callback)
        {
            ...
            if (!addToAlbumsIds.IsNullOrEmpty())
                code = code + string.Format(format, (object)"addToAlbum", (object)videoId, (object)targetId, (object)addToAlbumsIds.GetCommaSeparated(), (object)ownerId) + Environment.NewLine;
            if (!removeFromAlbumsIds.IsNullOrEmpty())
                code += string.Format(format, (object)"removeFromAlbum", (object)videoId, (object)targetId, (object)removeFromAlbumsIds.GetCommaSeparated(), (object)ownerId);
        ...
        public void HideCatalogSection(int sectionId, Action<BackendResult<ResponseWithId, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<ResponseWithId>("video.hideCatalogSection", parameters, callback, (Func<string, ResponseWithId>)(jsonStr => new ResponseWithId()), false, true, new CancellationToken?());
        }
        ...
        public void GetVideoCatalog(int count, int itemsCount, string from, Action<BackendResult<GetCatalogResponse, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<GetCatalogResponse>(methodName, parameters, callback1, (Func<string, GetCatalogResponse>)(jsonStr => JsonConvert.DeserializeObject<GenericRoot<GetCatalogResponse>>(jsonStr).response), num1 != 0, num2 != 0, cancellationToken);
        }
        ...
        public void SearchVideo(string query, Dictionary<string, string> parameters, int offset, int count, Action<BackendResult<VKList<VKClient.Common.Backend.DataObjects.Video>, ResultCode>> callback)
        {
            if (parameters == null)
            ...
            Action<BackendResult<VKList<VKClient.Common.Backend.DataObjects.Video>, ResultCode>> callback1 = callback;
            int num1 = 0;
            int num2 = 1;
            CancellationToken? cancellationToken = new CancellationToken?();
            VKRequestsDispatcher.DispatchRequestToVK<VKList<VKClient.Common.Backend.DataObjects.Video>>(methodName, parameters1, callback1, (Func<string, VKList<VKClient.Common.Backend.DataObjects.Video>>)(jsonStr => JsonConvert.DeserializeObject<GenericRoot<VKList<VKClient.Common.Backend.DataObjects.Video>>>(jsonStr).response), num1 != 0, num2 != 0, cancellationToken);
        }

        public void SearchVideo(string query, int offset, int count, Action<BackendResult<VideoSearchResponse, ResultCode>> callback)
        {
            VKRequestsDispatcher.Execute<VideoSearchResponse>(string.Format("var q = \"{0}\";\r\n                                var offset = {1};\r\n                                var count = {2};\r\n                                var videos = API.video.search({{\"q\": q, \"search_own\": 1, \"offset\": offset, \"count\": count}});\r\n                                var myVideos = [];\r\n                                var globalVideos = [];\r\n                                var i = 0;\r\n                                var items = videos.items;\r\n                                while (i < items.length) {{\r\n                                    var video = items[i];\r\n                                    if (video.owner_id == {3}) {{\r\n                                        myVideos.push(video);\r\n                                    }} else {{\r\n                                        globalVideos.push(video);\r\n                                    }}\r\n                                    i = i + 1;\r\n                                }}\r\n\r\n                                return  {{\"MyVideos\": myVideos, \"GlobalVideos\": globalVideos, \"TotalCount\": videos.count}};", (object)query, (object)offset, (object)count, (object)AppGlobalStateManager.Current.LoggedInUserId), callback, (Func<string, VideoSearchResponse>)(jsonStr =>
            {
        ...
        public void PlayStarted(long videoId, long ownerId)
        {
            ...
            int num2 = 1;
            CancellationToken? cancellationToken = new CancellationToken?();
            VKRequestsDispatcher.DispatchRequestToVK<object>(methodName, parameters, callback, (Func<string, object>)(jsonStr => new object()), num1 != 0, num2 != 0, cancellationToken);
        }
        ...
        public void AddAlbum(string albumName, PrivacyInfo albumPrivacy, Action<BackendResult<VideoAlbum, ResultCode>> callback, long? groupId = null)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<VideoAlbum>("video.addAlbum", parameters, callback, (Func<string, VideoAlbum>)null, false, true, new CancellationToken?());
        }
        ...
        public void EditAlbum(string albumName, long albumId, PrivacyInfo albumPrivacy, Action<BackendResult<object, ResultCode>> callback, long? groupId = null)
        {
            ...
            if (albumPrivacy != null)
                parameters["privacy"] = albumPrivacy.ToString();
            VKRequestsDispatcher.DispatchRequestToVK<object>("video.editAlbum", parameters, callback, (Func<string, object>)null, false, true, new CancellationToken?());
        }
        ...
        public void DeleteAlbum(long albumId, Action<BackendResult<object, ResultCode>> callback, long? groupId = null)
        {
            ...
            if (groupId.HasValue && groupId.Value > 0L)
                parameters["group_id"] = groupId.Value.ToString();
            VKRequestsDispatcher.DispatchRequestToVK<object>("video.deleteAlbum", parameters, callback, (Func<string, object>)null, false, true, new CancellationToken?());
        }
        ...
        public void MoveVideoToAlbum(List<long> videoIds, long albumId, Action<BackendResult<object, ResultCode>> callback, long? groupId = null)
        {
            ...
            if (groupId.HasValue)
                parameters["group_id"] = groupId.Value.ToString();
            VKRequestsDispatcher.DispatchRequestToVK<object>("video.moveToAlbum", parameters, callback, (Func<string, object>)null, false, true, new CancellationToken?());
        }
        ...
        public void DeleteVideo(long videoId, long ownerId, Action<BackendResult<object, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<object>("video.delete", parameters, callback, (Func<string, object>)null, false, true, new CancellationToken?());
        }
        ...
        public void GetAlbums(long userOrGroupId, bool isGroup, bool need_system, int offset, int count, Action<BackendResult<VKList<VideoAlbum>, ResultCode>> callback)
        {
            ...
            int num2 = 1;
            CancellationToken? cancellationToken = new CancellationToken?();
            VKRequestsDispatcher.DispatchRequestToVK<VKList<VideoAlbum>>(methodName, parameters, callback1, (Func<string, VKList<VideoAlbum>>)(jsonStr => JsonConvert.DeserializeObject<GenericRoot<VKList<VideoAlbum>>>(jsonStr).response), num1 != 0, num2 != 0, cancellationToken);
        }

        public void GetVideos(long userOrGroupId, bool isGroup, int offset, int count, Action<BackendResult<VKList<VKClient.Common.Backend.DataObjects.Video>, ResultCode>> callback, long albumId = 0, bool extended = true)
        {
            Dictionary<string, string> dictionary = new Dictionary<string, string>();
            if (isGroup)
                dictionary["group_id"] = userOrGroupId.ToString();
            ...
            int num2 = 1;
            CancellationToken? cancellationToken = new CancellationToken?();
            VKRequestsDispatcher.DispatchRequestToVK<VKList<VKClient.Common.Backend.DataObjects.Video>>(methodName, parameters, callback1, (Func<string, VKList<VKClient.Common.Backend.DataObjects.Video>>)(jsonStr => JsonConvert.DeserializeObject<GenericRoot<VKList<VKClient.Common.Backend.DataObjects.Video>>>(jsonStr).response), num1 != 0, num2 != 0, cancellationToken);
        }

        public void GetVideoById(long oid, long vid, string accessKey, Action<BackendResult<List<VKClient.Common.Backend.DataObjects.Video>, ResultCode>> callback)
        {
            Dictionary<string, string> parameters = new Dictionary<string, string>();
            ...
            VKRequestsDispatcher.DispatchRequestToVK<List<VKClient.Common.Backend.DataObjects.Video>>("video.get", parameters, callback, VideoService._deserializeFunc, false, true, new CancellationToken?());
        }
        ...
        private string FormatVideosList(List<KeyValuePair<long, long>> videos)
        {
            ...
            {
                str += string.Format("{0}_{1}", (object)video.Key, (object)video.Value);
      ...
      {
        {
          ...
          string.Format("\r\n\r\nvar new_comment_id = API.video.createComment({{\r\n    owner_id: {0},\r\n    video_id: {1},\r\n    message: \"{2}\",\r\n    sticker_id: {3},\r\n    reply_to_comment: {4},\r\n    attachments: \"{5}\",\r\n    sticker_referrer: \"{6}\"\r\n}});\r\n\r\nvar last_comments = API.video.getComments({{\r\n    owner_id: {7},\r\n    video_id: {8},\r\n    need_likes: 1,\r\n    count: 10,\r\n    sort: \"desc\",\r\n    preview_length: 0,\r\n    allow_group_comments: 1\r\n}}).items;\r\n\r\nvar i = last_comments.length - 1;\r\nwhile (i >= 0)\r\n{{\r\n    if (last_comments[i].id == new_comment_id)\r\n        return last_comments[i];\r\n\r\n    i = i - 1;\r\n}}\r\n\r\nreturn null;\r\n\r\n                ", (object) ownerId, (object) vid, (object) text.Replace("\"", "\\\"").Replace("\n", "\\n").Replace("\r", "\\r"), (object) stickerId, (object) replyCid, (object) attachments.GetCommaSeparated(","), (object) stickerReferrer, (object) ownerId, (object) vid)
            ...
            int num2 = 1;
            CancellationToken? cancellationToken = new CancellationToken?();
            VKRequestsDispatcher.DispatchRequestToVK<Comment>(methodName, parameters, callback1, (Func<string, Comment>)(jsonStr => JsonConvert.DeserializeObject<VKRequestsDispatcher.GenericRoot<Comment>>(jsonStr).response), num1 != 0, num2 != 0, cancellationToken);
        }
        ...
        public void DeleteComment(long ownerId, long vid, long cid, Action<BackendResult<ResponseWithId, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<ResponseWithId>("video.deleteComment", parameters, callback, (Func<string, ResponseWithId>)(jsonStr => new ResponseWithId()), false, true, new CancellationToken?());
        }
        ...
        public void EditComment(long cid, string text, long ownerId, List<string> attachments, Action<BackendResult<ResponseWithId, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<ResponseWithId>("video.editComment", parameters, callback, (Func<string, ResponseWithId>)(jsonStr => new ResponseWithId()), false, true, new CancellationToken?());
        }
        ...
        public void EditVideo(long videoId, long ownerId, string name, string description, PrivacyInfo privacyView, PrivacyInfo privacyComment, Action<BackendResult<ResponseWithId, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<ResponseWithId>("video.edit", parameters, callback, (Func<string, ResponseWithId>)null, false, true, new CancellationToken?());
        }
        ...
        public void Delete(long ownerId, long vid, Action<BackendResult<long, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<long>("video.delete", parameters, (Action<BackendResult<long, ResultCode>>)(res =>
            {
                ...
                callback(res);
            }), (Func<string, long>)null, false, true, new CancellationToken?());
        }
        ...
        public void Report(long ownerId, long id, ReportReason reportReason, Action<BackendResult<ResponseWithId, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<ResponseWithId>("video.report", parameters, callback, (Func<string, ResponseWithId>)(jsonStr => new ResponseWithId()), false, true, new CancellationToken?());
        }
        ...
        public void ReportComment(long ownerId, long commentId, ReportReason reportReason, Action<BackendResult<ResponseWithId, ResultCode>> callback)
        {
            ...
            parameters["reason"] = ((int)reportReason).ToString();
            VKRequestsDispatcher.DispatchRequestToVK<ResponseWithId>("video.reportComment", parameters, callback, (Func<string, ResponseWithId>)(jsonStr => new ResponseWithId()), false, true, new CancellationToken?());
        }
        ...
        public void UploadVideo(Stream stream, bool isPrivate, long albumId, long groupId, string name, string description, Action<BackendResult<SaveVideoResponse, ResultCode>> callback, Action<double> progressCallback = null, Cancellation c = null, PrivacyInfo privacyViewInfo = null, PrivacyInfo privacyCommentInfo = null)
        {
            ...
            }), (Func<string, SaveVideoResponse>)null, false, true, new CancellationToken?());
        }
    }
}

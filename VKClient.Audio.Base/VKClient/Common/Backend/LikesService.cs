...
namespace VKClient.Common.Backend
{
  public class LikesService
  {
    ...
    public void AddRemoveLike(bool add, long owner_id, long item_id, LikeObjectType objectType, Action<BackendResult<ResponseWithId, ResultCode>> callback, string accessKey = "")
    {
      ...
      EventAggregator.Current.Publish((object) new ObjectLikedUnlikedEvent()
      {
        Liked = add,
        ItemId = item_id,
        OwnerId = owner_id,
      ...
      VKRequestsDispatcher.DispatchRequestToVK<ResponseWithId>(methodName, parameters, callback1, (Func<string, ResponseWithId>) (jsonStr => new ResponseWithId()), num1 != 0, num2 != 0, cancellationToken);
    }

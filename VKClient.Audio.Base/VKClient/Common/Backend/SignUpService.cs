...
namespace VKClient.Common.Backend
{
    public class SignUpService
    {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<string>("auth.checkPhone", new Dictionary<string, string>()
      {
      ...
      }, callbackAction, (Func<string, string>)null, false, true, new CancellationToken?());
        }
        ...
        public void SignUp(string phone, string firstName, string lastName, bool voice, bool isMale, string sid, Action<BackendResult<string, ResultCode>> callbackAction)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<string>(methodName, parameters, callback, (Func<string, string>)(jsonStr => JsonConvert.DeserializeObject<KeyValuePair<string, string>>(jsonStr).Value), num1 != 0, num2 != 0, cancellationToken);
        }
        ...
        public void ConfirmSignUp(string phone, string code, string password, Action<BackendResult<SignupConfirmation, ResultCode>> callbackAction)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<SignupConfirmation>("auth.confirm", parameters, callbackAction, (Func<string, SignupConfirmation>)null, false, true, new CancellationToken?());
        }
    }
}

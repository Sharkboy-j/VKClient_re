...
namespace VKClient.Common.Backend
{
  public class GroupsService
  {
    ...
    public void GetUserGroups(long uid, int offset, int count, Action<BackendResult<GroupsLists, ResultCode>> callback)
    {
      ...
      VKRequestsDispatcher.DispatchRequestToVK<GroupsLists>(methodName, parameters, callback1, (Func<string, GroupsLists>) (jsonStr =>
      {
        GenericRoot<GroupsListWithInvitations> genericRoot = JsonConvert.DeserializeObject<GenericRoot<GroupsListWithInvitations>>(jsonStr);
        GroupsLists groupsLists = new GroupsLists();
        groupsLists.Communities = genericRoot.response.groups.items;
        groupsLists.CommunitiesCount = groupsLists.Communities.Count;
        groupsLists.Invitations = genericRoot.response.invitations;
        groupsLists.Events = groupsLists.Communities.Where<Group>((Func<Group, bool>) (g => g.GroupType == GroupType.Event)).ToList<Group>();
        groupsLists.EventsCount = groupsLists.Events.Count;
        groupsLists.AdminGroups = groupsLists.Communities.Where<Group>((Func<Group, bool>) (g => g.admin_level > 0)).ToList<Group>();
        groupsLists.AdminGroupsCount = groupsLists.AdminGroups.Count;
        return groupsLists;
      }), num1 != 0, num2 != 0, cancellationToken);
    }
    ...
    public void Join(long gid, bool notSure, Action<BackendResult<OwnCounters, ResultCode>> callback)
    {
      VKRequestsDispatcher.Execute<OwnCounters>(string.Format("var gid = {0};\r\n\r\nAPI.groups.join({{\"group_id\": gid, \"not_sure\":{1}}});\r\n\r\nreturn API.getCounters();", (object) gid, notSure ? (object) "1" : (object) "0"), callback, new Func<string, OwnCounters>(CountersDeserializerHelper.Deserialize), false, true, new CancellationToken?());
    }

    public void Leave(long gid, Action<BackendResult<OwnCounters, ResultCode>> callback)
    {
      VKRequestsDispatcher.Execute<OwnCounters>(string.Format("var gid = {0};\r\n\r\nAPI.groups.leave({{\"group_id\": gid}});\r\n\r\nreturn API.getCounters();", (object) gid), callback, new Func<string, OwnCounters>(CountersDeserializerHelper.Deserialize), false, true, new CancellationToken?());
    }
    ...
    public void Search(string searchStr, int offset, int count, Action<BackendResult<VKList<Group>, ResultCode>> callback)
    {
      ...
      VKRequestsDispatcher.DispatchRequestToVK<VKList<Group>>("groups.search", parameters, callback, (Func<string, VKList<Group>>) null, false, true, new CancellationToken?());
    }
    ...
    public void GetGroupInfo(long groupId, Action<BackendResult<GroupData, ResultCode>> callback)
    {
      ...
      }, callback, (Func<string, GroupData>) (jsonStr =>
      {
        ...
        if (Enum.IsDefined(typeof (ProfileMainSectionType), (object) response.group.main_section))
    ...
    public void DeleteComment(long gid, long tid, long cid, Action<BackendResult<ResponseWithId, ResultCode>> callback)
    {
      ...
      VKRequestsDispatcher.DispatchRequestToVK<ResponseWithId>("board.deleteComment", parameters, callback, (Func<string, ResponseWithId>) (j => new ResponseWithId()), false, true, new CancellationToken?());
    }
    ...
    public void EditComment(long gid, long tid, long cid, string text, List<string> attachmentIds, Action<BackendResult<ResponseWithId, ResultCode>> callback)
    {
      ...
      VKRequestsDispatcher.DispatchRequestToVK<ResponseWithId>("board.editComment", parameters, callback, (Func<string, ResponseWithId>) (jsonStr => new ResponseWithId()), false, true, new CancellationToken?());
    }
    ...
    public void CreateTopic(long group_id, string title, string text, List<string> attachments, bool fromGroup, Action<BackendResult<ResponseWithId, ResultCode>> callback)
    {
      ...
      int num2 = 1;
      CancellationToken? cancellationToken = new CancellationToken?();
      VKRequestsDispatcher.DispatchRequestToVK<ResponseWithId>(methodName, parameters, callback1, (Func<string, ResponseWithId>) (jsonStr => JsonConvert.DeserializeObject<ResponseWithId>(jsonStr)), num1 != 0, num2 != 0, cancellationToken);
    }
    ...
    public void GetCatalog(int categoryId, Action<BackendResult<VKList<Group>, ResultCode>> callback)
    {
      ...
      VKRequestsDispatcher.DispatchRequestToVK<VKList<Group>>("groups.getCatalog", parameters, callback, (Func<string, VKList<Group>>) null, false, true, new CancellationToken?());
    }
    ...
    public void GetCatalogCategoriesPreview(Action<BackendResult<GroupCatalogInfoExtended, ResultCode>> callback)
    {
      Dictionary<string, string> parameters = new Dictionary<string, string>();
      parameters["extended"] = "1";
      VKRequestsDispatcher.DispatchRequestToVK<GroupCatalogInfoExtended>("groups.getCatalogInfo", parameters, callback, (Func<string, GroupCatalogInfoExtended>) null, false, true, new CancellationToken?());
    }
    ...
    public void CreateCommunity(string name, string type, int subtype, Action<BackendResult<Group, ResultCode>> callback)
    {
      ...
      }, callback, (Func<string, Group>) null, false, true, new CancellationToken?());
    }
    ...
    public void GetCommunitySettings(long id, Action<BackendResult<CommunitySettings, ResultCode>> callback)
    {
      ...
      int num2 = 1;
      CancellationToken? cancellationToken = new CancellationToken?();
      VKRequestsDispatcher.DispatchRequestToVK<CommunitySettings>(methodName, parameters, callback1, (Func<string, CommunitySettings>) local, num1 != 0, num2 != 0, cancellationToken);
    }
    ...
    public void SetCommunityInformation(long id, string name, string description, long category, long subcategory, string site, int accessLevel, string domain, int ageLimits, string foundationDate, long? eventOrganizerId, string eventOrganizerPhone, string eventOrganizerEmail, int eventStartDate, int eventFinishDate, Action<BackendResult<int, ResultCode>> callback)
    {
      ...
      VKRequestsDispatcher.DispatchRequestToVK<int>("groups.edit", parameters, callback, (Func<string, int>) null, false, true, new CancellationToken?());
    }
    ...
    public void SetCommunityServices(long id, int wallOrComments, int photos, int videos, int audios, int documents, int discussions, int links, int events, int contacts, int strongLanguageFilter, int keyWordsFilter, string keyWords, Action<BackendResult<int, ResultCode>> callback)
    {
      ...
      }, callback, (Func<string, int>) null, false, true, new CancellationToken?());
    }
    ...
    public void GetRequests(long id, int offset, int count, Action<BackendResult<VKList<User>, ResultCode>> callback)
    {
      ...
      }, callback, (Func<string, VKList<User>>) null, false, true, new CancellationToken?());
    }
    ...
    public void HandleRequest(long communityId, long userId, bool isAcception, Action<BackendResult<int, ResultCode>> callback)
    {
      ...
      VKRequestsDispatcher.DispatchRequestToVK<int>(isAcception ? "groups.approveRequest" : "groups.removeUser", parameters, callback, (Func<string, int>) null, false, true, new CancellationToken?());
    }
    ...
    public void GetCommunity(long communityId, string fields, Action<BackendResult<List<Group>, ResultCode>> callback)
    {
      ...
      }, callback, (Func<string, List<Group>>) null, false, true, new CancellationToken?());
    }
    ...
    public void AddLink(long communityId, string url, string description, Action<BackendResult<GroupLink, ResultCode>> callback)
    {
      ...
      }, callback, (Func<string, GroupLink>) null, false, true, new CancellationToken?());
    }
    ...
    public void GetSubscribers(long communityId, int offset, int count, string filter, bool needManagersAndContacts, Action<BackendResult<CommunitySubscribers, ResultCode>> callback)
    {
      ...
      int num2 = 1;
      CancellationToken? cancellationToken = new CancellationToken?();
      VKRequestsDispatcher.DispatchRequestToVK<CommunitySubscribers>(methodName, parameters, callback1, (Func<string, CommunitySubscribers>) local, num1 != 0, num2 != 0, cancellationToken);
    }
    ...
    public void SearchSubscribers(string q, long communityId, int offset, int count, bool isFriendsOnly, Action<BackendResult<VKList<User>, ResultCode>> callback)
    {
      ...
      VKRequestsDispatcher.DispatchRequestToVK<VKList<User>>("users.search", parameters, callback, (Func<string, VKList<User>>) null, false, true, new CancellationToken?());
    }
    ...
    public void GetManagers(long communityId, int offset, int count, bool needContacts, Action<BackendResult<CommunityManagers, ResultCode>> callback)
    {
      ...
      int num2 = 1;
      CancellationToken? cancellationToken = new CancellationToken?();
      VKRequestsDispatcher.DispatchRequestToVK<CommunityManagers>(methodName, parameters, callback1, (Func<string, CommunityManagers>) local, num1 != 0, num2 != 0, cancellationToken);
    }
    ...
    public void EditManager(long communityId, long userId, CommunityManagementRole role, bool isContact, string position, string email, string phone, Action<BackendResult<int, ResultCode>> callback)
    {
      ...
      VKRequestsDispatcher.DispatchRequestToVK<int>("groups.editManager", parameters, callback, (Func<string, int>) null, false, true, new CancellationToken?());
    }
    ...
    public void SetCommunityPlacement(long communityId, long countryId, long cityId, string address, string title, double latitude, double longitude, Action<BackendResult<PlacementEditingResult, ResultCode>> callback)
    {
      ...
      }, callback, (Func<string, PlacementEditingResult>) null, false, true, new CancellationToken?());
    }

...
namespace VKClient.Common.Backend
{
  public static class VKRequestsDispatcher
  {
    ...
    public static void DispatchLoginRequest(string login, string password, string code, bool forceSms, Action<BackendResult<AutorizationData, ResultCode>> callback, CancellationToken? cancellationToken = null)
    {
      ...
      string index1 = "grant_type";
      string str1 = "password";
      dictionary1[index1] = str1;
      string index2 = "client_id";
      string applicationId = VKConstants.ApplicationID;
      dictionary1[index2] = applicationId;
      string index3 = "client_secret";
      string applicationSecretKey = VKConstants.ApplicationSecretKey;
      dictionary1[index3] = applicationSecretKey;
      string index4 = "username";
      string str2 = login;
      dictionary1[index4] = str2;
      string index5 = "password";
      string str3 = password;
      dictionary1[index5] = str3;
      string index6 = "2fa_supported";
      string str4 = "1";
      dictionary1[index6] = str4;
      string index7 = "device_id";
      string deviceId = AppGlobalStateManager.Current.GlobalState.DeviceId;
      dictionary1[index7] = deviceId;
      ...
      VKRequestsDispatcher.DoDispatch<AutorizationData>(VKRequestsDispatcher.LoginUri, "", parameters, callback, new Func<string, AutorizationData>(JsonConvert.DeserializeObject<AutorizationData>), false, true, cancellationToken,  null);
    }
          ...
          else if (backendResult.ResultCode == ResultCode.ConfirmationRequired)
          {
            if (!VKRequestsDispatcher.GetIsResponseCancelled(cancellationToken))
            {
              ...
              if (confirmationHandler != null)
              {
                ...
                confirmationHandler.Confirm(confirmationText, (Action<bool>) (confirmed =>
                {
                  if (confirmed)
                  {

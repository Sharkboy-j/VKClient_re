        ...
        public string UniqueIdForAttachment
        {
            get
            {
                if (!string.IsNullOrWhiteSpace(this.access_key))
                    return string.Format("doc{0}_{1}_{2}", (object)this.owner_id, (object)this.id, (object)this.access_key);
                return string.Format("doc{0}_{1}", (object)this.owner_id, (object)this.id);
            }
        }
        ...
        public bool IsVideoGif
        {
            get
            {
                ...
                else
                {
                    ...
                    str = video != null ? video.src : (string)null;
                }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        str = previewPhotoSize != null ? previewPhotoSize.src : (string)null;
                    }
                }
            }
            photo1.src_xbig = str;

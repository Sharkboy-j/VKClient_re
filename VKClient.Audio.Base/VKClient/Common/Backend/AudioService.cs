...
namespace VKClient.Common.Backend
{
  public class AudioService
  {
    ...
    public void DeleteAudios(List<long> list)
    {
      ...
      VKRequestsDispatcher.Execute<VKClient.Common.Backend.DataObjects.ResponseWithId>(code, callback, (Func<string, VKClient.Common.Backend.DataObjects.ResponseWithId>) (jsonStr => new VKClient.Common.Backend.DataObjects.ResponseWithId()), num1 != 0, num2 != 0, cancellationToken);
    }

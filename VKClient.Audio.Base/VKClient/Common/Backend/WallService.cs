    ...
    public class WallService
    {
        ...
        public void WallSubscriptionsUnsubscribe(List<long> ownerIds, Action<BackendResult<ResponseWithId, ResultCode>> callback)
        {
            ...
            foreach (long ownerId in ownerIds)
                code = code + string.Format(format, (object)ownerId) + Environment.NewLine;
        ...
        public void WallSubscriptionsSubscribe(long ownerId, Action<BackendResult<ResponseWithId, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<ResponseWithId>("wall.subscribe", parameters, callback, (Func<string, ResponseWithId>)(jsonStr => new ResponseWithId()), false, true, new CancellationToken?());
        }
        ...
        public void PinUnpin(bool pin, long ownerId, long postId, Action<BackendResult<ResponseWithId, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<ResponseWithId>(pin ? "wall.pin" : "wall.unpin", parameters, callback, (Func<string, ResponseWithId>)(jsonStr => new ResponseWithId()), false, true, new CancellationToken?());
        }
        ...
        public void Edit(WallPostRequestData postData, Action<BackendResult<ResponseWithId, ResultCode>> callback)
        {
            ...
            if (postData.latitude.HasValue)
            {
                ...
                string string2 = nullable.Value.ToString((IFormatProvider)CultureInfo.InvariantCulture);
                dictionary2[index2] = string2;
            }
            ...
            if (postData.publish_date.HasValue)
            {
                ...
                string string2 = num.ToString((IFormatProvider)CultureInfo.InvariantCulture);
                dictionary2[index2] = string2;
            }
        ...
        public void Post(WallPostRequestData postData, Action<BackendResult<ResponseWithId, ResultCode>> callback)
        {
            ...
            if (postData.latitude.HasValue)
            {
                ...
                string index = "lat";
                nullable = postData.latitude;
                string @string = nullable.Value.ToString((IFormatProvider)CultureInfo.InvariantCulture);
                dictionary[index] = @string;
            }
            nullable = postData.longitude;
            if (nullable.HasValue)
            ...
            if (postData.publish_date.HasValue)
            {
                ...
                num = postData.publish_date.Value;
                string @string = num.ToString((IFormatProvider)CultureInfo.InvariantCulture);
                dictionary[index] = @string;
            }
        ...
        public void Report(long ownerId, long id, ReportReason reportReason, Action<BackendResult<ResponseWithId, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<ResponseWithId>("wall.reportPost", parameters, callback, (Func<string, ResponseWithId>)(jsonStr => new ResponseWithId()), false, true, new CancellationToken?());
        }
        ...
        public void ReportComment(long ownerId, long commentId, ReportReason reportReason, Action<BackendResult<ResponseWithId, ResultCode>> callback)
        {
            ...
            parameters["reason"] = ((int)reportReason).ToString();
            VKRequestsDispatcher.DispatchRequestToVK<ResponseWithId>("wall.reportComment", parameters, callback, (Func<string, ResponseWithId>)(jsonStr => new ResponseWithId()), false, true, new CancellationToken?());
        }
        ...
        public void GetWallPostByIdWithComments(long postId, long ownerId, int offset, int countToRead, int knownTotalCount, bool needWallPost, Action<BackendResult<GetWallPostResponseData, ResultCode>> callback, long pollId = 0, long pollOwnerId = 0, LikeObjectType likeObjType = LikeObjectType.post)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<GetWallPostResponseData>("execute", parameters, callback, (Func<string, GetWallPostResponseData>)(jsonStr =>
            {
                ...
                if (genericRoot.response.LikesAll.items != null)
                    genericRoot.response.LikesAll.users = new List<UserLike>(genericRoot.response.LikesAll.items.Select<long, UserLike>((Func<long, UserLike>)(it => new UserLike() { uid = it })));
            ...
            Dictionary<string, string> dictionary = new Dictionary<string, string>()
      {
        {
          "code",
          string.Format("\r\n\r\nvar new_comment_id = API.wall.addComment({{\r\n    owner_id: {0},\r\n    post_id: {1},\r\n    text: \"{2}\",\r\n    from_group: {3},\r\n    sticker_id: {4},\r\n    reply_to_comment: {5},\r\n    attachments: \"{6}\",\r\n    sticker_referrer: \"{7}\"\r\n}}).comment_id;\r\n\r\nvar last_comments = API.wall.getComments({{\r\n    owner_id: {8},\r\n    post_id: {9},\r\n    need_likes: 1,\r\n    count: 10,\r\n    sort: \"desc\",\r\n    preview_length: 0,\r\n    allow_group_comments: 1\r\n}}).items;\r\n\r\nvar i = last_comments.length - 1;\r\nwhile (i >= 0)\r\n{{\r\n    if (last_comments[i].id == new_comment_id)\r\n        return last_comments[i];\r\n\r\n    i = i - 1;\r\n}}\r\n\r\nreturn null;\r\n\r\n                ", (object) ownerId, (object) postId, (object) text.Replace("\"", "\\\"").Replace("\n", "\\n").Replace("\r", "\\r"), (object) (fromGroup ? "1" : "0"), (object) stickerId, (object) replyToCid, (object) attachmentIds.GetCommaSeparated(","), (object) stickerReferrer, (object) ownerId, (object) postId)
        }
      };
        ...
        public void DeleteComment(long ownerId, long cid, Action<BackendResult<ResponseWithId, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<ResponseWithId>("wall.deleteComment", parameters, callback, (Func<string, ResponseWithId>)(jsonStr => new ResponseWithId()), false, true, new CancellationToken?());
        }
        ...
        {
            StringBuilder stringBuilder1 = new StringBuilder().AppendFormat("var users =  API.users.get({{\"user_ids\":\"{0}\", \"fields\":\"wall_default\"}});", (object)requestData.Select<WallService.WallRequestData, long>((Func<WallService.WallRequestData, long>)(r => r.UserId)).ToList<long>().GetCommaSeparated()).Append(Environment.NewLine);
            for (int index = 0; index < requestData.Count; ++index)
            {
                WallService.WallRequestData wallRequestData = requestData[index];
                stringBuilder1 = stringBuilder1.AppendFormat("var wall{3} = API.wall.get({{\"owner_id\":{0}, \"offset\":{1}, \"count\":{2}, \"extended\":1, \"filter\":users[{3}].wall_default}});", (object)wallRequestData.UserId, (object)wallRequestData.Offset, (object)wallRequestData.Count, (object)index).AppendFormat(Environment.NewLine);
            }
            ...
            for (int index = 0; index < requestData.Count; ++index)
            {
                ...
                stringBuilder2 = stringBuilder2.AppendFormat("\"Wall{0}\":wall{0} ", (object)index);
            }
            VKRequestsDispatcher.Execute<List<WallData>>(stringBuilder2.Append("};").ToString(), callback, (Func<string, List<WallData>>)(jsonStr =>
            {
                ...
                jsonStr = VKRequestsDispatcher.FixFalseArray(jsonStr, "groups", false);
                for (int index = 0; index < requestData.Count; ++index)
                    jsonStr = VKRequestsDispatcher.FixFalseArray(jsonStr, "Wall" + (object)index, true);
        ...
        public void GetWall(long ownerId, int offset, int count, Action<BackendResult<WallData, ResultCode>> callback, string filter = "all")
        {
            ...
            int num2 = 1;
            CancellationToken? cancellationToken = new CancellationToken?();
            VKRequestsDispatcher.DispatchRequestToVK<WallData>(methodName, parameters, callback1, (Func<string, WallData>)(jsonStr => JsonConvert.DeserializeObject<GenericRoot<WallData>>(jsonStr).response), num1 != 0, num2 != 0, cancellationToken);
        }
        ...
        public void Repost(long ownerId, long obj_id, string message, RepostObject obj, long gid, Action<BackendResult<RepostResult, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<RepostResult>("wall.repost", parameters, (Action<BackendResult<RepostResult, ResultCode>>)(res =>
            {
                if (res.ResultCode == ResultCode.Succeeded)
                    EventAggregator.Current.Publish((object)new RepostedObjectEvent()
                    {
                        owner_id = ownerId,
                        obj_id = obj_id,
                        rObj = obj,
                ...
                callback(res);
            }), (Func<string, RepostResult>)null, false, true, new CancellationToken?());
        }
        ...
        public void DeletePost(long ownerId, long post_id)
        {
            ...
            int num2 = 1;
            CancellationToken? cancellationToken = new CancellationToken?();
            //Action<BackendResult<object, ResultCode>> callback;
        ...
        public void EditComment(WallPostRequestData data, Action<BackendResult<long, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<long>("wall.editComment", parameters, callback, (Func<string, long>)null, false, true, new CancellationToken?());
        }
        ...
        public void Search(long ownerId, string domain, string query, int count, int offset, Action<BackendResult<WallData, ResultCode>> callback)
        {
            ...
            string index2 = "count";
            string string1 = count.ToString();
            dictionary[index2] = string1;
            string index3 = "offset";
            string string2 = offset.ToString();
            dictionary[index3] = string2;
            string index4 = "extended";
            string str2 = "1";
            dictionary[index4] = str2;
            Dictionary<string, string> parameters = dictionary;
            if (ownerId != 0L)
                parameters["owner_id"] = ownerId.ToString();
            else if (!string.IsNullOrEmpty(domain))
                parameters["domain"] = domain;
            VKRequestsDispatcher.DispatchRequestToVK<WallData>("wall.search", parameters, callback, (Func<string, WallData>)null, false, true, new CancellationToken?());
        }
        ...
        public void SendStats(List<WallPost> viewedWallPosts)
        {
            ...
            foreach (WallPost viewedWallPost in viewedWallPosts)
            {
                ...
                string str2 = string1 + str1 + string2;
                ...
                if (!viewedWallPost.copy_history.IsNullOrEmpty())
                {
                    foreach (WallPost wallPost in viewedWallPost.copy_history)
                    {
                        ...
                        long local = wallPost.owner_id;
                        string str3 = "_";
                        num = wallPost.id;
                        string string3 = num.ToString();
                        string str4 = local.ToString() + str3 + string3;
                        stringList2.Add(str4);//re
                    }
                }
            }
            Dictionary<string, string> dictionary = new Dictionary<string, string>();
            ...
            VKRequestsDispatcher.DispatchRequestToVK<ResponseWithId>(methodName, parameters, callback, (Func<string, ResponseWithId>)(jsonStr => new ResponseWithId()), num1 != 0, num2 != 0, cancellationToken);
        }

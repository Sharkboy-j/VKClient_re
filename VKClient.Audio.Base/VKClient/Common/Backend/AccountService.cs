...
namespace VKClient.Common.Backend
{
    public class AccountService
    {
        ...
        public void RegisterDevice(string deviceId, string token, string deviceModelViewable, string systemVersion, string appVersion, string settings, Action<BackendResult<VKClient.Common.Backend.DataObjects.ResponseWithId, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<VKClient.Common.Backend.DataObjects.ResponseWithId>("account.registerDevice", parameters, callback, (Func<string, VKClient.Common.Backend.DataObjects.ResponseWithId>)(jsonStr => new VKClient.Common.Backend.DataObjects.ResponseWithId()), false, true, new CancellationToken?());
        }
        ...
        public void UnregisterDevice(string deviceId, Action<BackendResult<VKClient.Common.Backend.DataObjects.ResponseWithId, ResultCode>> callback)
        {
            Dictionary<string, string> parameters = new Dictionary<string, string>();
            parameters["device_id"] = deviceId;
            VKRequestsDispatcher.DispatchRequestToVK<VKClient.Common.Backend.DataObjects.ResponseWithId>("account.unregisterDevice", parameters, callback, (Func<string, VKClient.Common.Backend.DataObjects.ResponseWithId>)(jsonStr => new VKClient.Common.Backend.DataObjects.ResponseWithId()), false, true, new CancellationToken?());
        }
        ...
        public void CheckShortName(string shortName, Action<BackendResult<CheckNameResponse, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<CheckNameResponse>("utils.checkScreenName", parameters, callback, (Func<string, CheckNameResponse>)null, false, true, new CancellationToken?());
        }
        ...
        public void SetShortName(string shortName, Action<BackendResult<SaveProfileResponse, ResultCode>> callback)
        {
            Dictionary<string, string> parameters = new Dictionary<string, string>();
            parameters["screen_name"] = shortName;
            VKRequestsDispatcher.DispatchRequestToVK<SaveProfileResponse>("account.saveProfileInfo", parameters, callback, (Func<string, SaveProfileResponse>)null, false, true, new CancellationToken?());
        }
        ...
        public void SetInfo(string name, string val, Action<BackendResult<VKClient.Common.Backend.DataObjects.ResponseWithId, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<VKClient.Common.Backend.DataObjects.ResponseWithId>("account.setInfo", parameters, callback, (Func<string, VKClient.Common.Backend.DataObjects.ResponseWithId>)(jsonStr => new VKClient.Common.Backend.DataObjects.ResponseWithId()), false, true, new CancellationToken?());
        }
        ...
        public void ChangePassword(string oldPassword, string newPassword, Action<BackendResult<ChangePasswordResponse, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<ChangePasswordResponse>("account.changePassword", parameters, callback, (Func<string, ChangePasswordResponse>)null, false, true, new CancellationToken?());
        }

        public void GetSettingsAccountInfo(Action<BackendResult<SettingsAccountInfo, ResultCode>> callback)
        {
            VKRequestsDispatcher.Execute<SettingsAccountInfo>("var account = API.account.getInfo();\r\n\r\nvar newsBanned = API.newsfeed.getBanned();\r\n\r\nvar pi = API.account.getProfileInfo();\r\n\r\nreturn {\"Account\": account, \"NewsBanned\":newsBanned, \"ProfileInfo\":pi};", callback, (Func<string, SettingsAccountInfo>)null, false, true, new CancellationToken?());
        }
            ...
            if (parameters.Count == 0)
            {
                ...
                VKRequestsDispatcher.DispatchRequestToVK<SaveProfileResponse>("account.saveProfileInfo", parameters, (Action<BackendResult<SaveProfileResponse, ResultCode>>)(res =>
                {
                    if (res.ResultCode == ResultCode.Succeeded && newPhotoData != null)
                        ...
                        callback(res);
                }), (Func<string, SaveProfileResponse>)null, false, true, new CancellationToken?());
        }
        ...
        {
            VKRequestsDispatcher.DispatchRequestToVK<PrivacySettingsInfo>("account.getPrivacySettings", new Dictionary<string, string>(), callback, (Func<string, PrivacySettingsInfo>)null, false, true, new CancellationToken?());
        }
        ...
        public void SetPrivacy(string key, string value, Action<BackendResult<VKClient.Common.Backend.DataObjects.ResponseWithId, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<VKClient.Common.Backend.DataObjects.ResponseWithId>("account.setPrivacy", parameters, callback, (Func<string, VKClient.Common.Backend.DataObjects.ResponseWithId>)(jsonStr => new VKClient.Common.Backend.DataObjects.ResponseWithId()), false, true, new CancellationToken?());
        }
        ...
        public void GetBannedUsers(int offset, int count, Action<BackendResult<VKList<User>, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<VKList<User>>("account.getBanned", parameters, callback, (Func<string, VKList<User>>)null, false, true, new CancellationToken?());
        }
        ...
        public void BanUser(long user_id, Action<BackendResult<VKClient.Common.Backend.DataObjects.ResponseWithId, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<VKClient.Common.Backend.DataObjects.ResponseWithId>("account.banUser", parameters, callback, (Func<string, VKClient.Common.Backend.DataObjects.ResponseWithId>)(jsonStr => new VKClient.Common.Backend.DataObjects.ResponseWithId()), false, true, new CancellationToken?());
        }
        ...
        public void UnbanUsers(List<long> user_ids, Action<BackendResult<VKClient.Common.Backend.DataObjects.ResponseWithId, ResultCode>> callback)
        {
            ...
            foreach (long userId in user_ids)
                code = code + string.Format(format, (object)userId) + Environment.NewLine;
            VKRequestsDispatcher.Execute<VKClient.Common.Backend.DataObjects.ResponseWithId>(code, callback, (Func<string, VKClient.Common.Backend.DataObjects.ResponseWithId>)(jsonStr => new VKClient.Common.Backend.DataObjects.ResponseWithId()), false, true, new CancellationToken?());
        }
        ...
        public void StatsTrackEvents(List<AppEventBase> appEvents, Action<BackendResult<VKClient.Common.Backend.DataObjects.ResponseWithId, ResultCode>> callback)
        {
            ...
            if (appEventBaseList2.Count > 0)
                code += string.Format(format2, (object)JsonConvert.SerializeObject((object)appEventBaseList2).Replace("\"", "\\\""));
            if (appEventBaseList1.Count > 0)
                code += string.Format(format1, (object)JsonConvert.SerializeObject((object)appEventBaseList1).Replace("\"", "\\\""));
            VKRequestsDispatcher.Execute<VKClient.Common.Backend.DataObjects.ResponseWithId>(code, callback, (Func<string, VKClient.Common.Backend.DataObjects.ResponseWithId>)(jsonStr => new VKClient.Common.Backend.DataObjects.ResponseWithId()), false, true, new CancellationToken?());
        }
        ...
        public void InternalGetNotifications(string device, string os, string appVersion, string locale, Action<BackendResult<VKClient.Common.Backend.DataObjects.ResponseWithId, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<VKClient.Common.Backend.DataObjects.ResponseWithId>("internal.getNotifications", parameters, callback, (Func<string, VKClient.Common.Backend.DataObjects.ResponseWithId>)(jsonStr => new VKClient.Common.Backend.DataObjects.ResponseWithId()), false, true, new CancellationToken?());
        }

        public void SetUserOnline(Action<BackendResult<object, ResultCode>> callback)
        {
            VKRequestsDispatcher.DispatchRequestToVK<object>("account.setOnline", new Dictionary<string, string>(), (Action<BackendResult<object, ResultCode>>)(res => callback(res)), (Func<string, object>)null, true, true, new CancellationToken?());
        }
        ...
        {
            Dictionary<string, string> parameters = new Dictionary<string, string>();
            string @string = nrOfSeconds.ToString();
            parameters.Add("device_id", device_id);
            parameters.Add("time", @string);
            if (chatId != 0L)
            ...
            VKRequestsDispatcher.DispatchRequestToVK<object>("account.setSilenceMode", parameters, callback, (Func<string, object>)null, false, true, new CancellationToken?());
        }
        ...
        public void GetCounters(Action<BackendResult<OwnCounters, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<OwnCounters>(methodName, parameters, callback1, (Func<string, OwnCounters>)(jsonStr => CountersDeserializerHelper.Deserialize(jsonStr)), num1 != 0, num2 != 0, cancellationToken);
        }
        ...
        public void GetBaseData(PhoneAppInfo phoneAppInfo, Action<BackendResult<AccountBaseData, ResultCode>> callback, bool loadStickersInfo = false)
        {
            ...
            }), true, true, new CancellationToken?());
        }

        public void GetIntermediateData(Action<BackendResult<AccountIntermediateData, ResultCode>> callback)
        {
            Dictionary<string, string> dictionary = new Dictionary<string, string>() { { "func_v", "2" } };// UPDATE: 4.8.0
            ...
            int num2 = 1;
            CancellationToken? cancellationToken = new CancellationToken?();
            VKRequestsDispatcher.DispatchRequestToVK<AccountIntermediateData>(methodName, parameters, callback1, (Func<string, AccountIntermediateData>)(jsonStr => JsonConvert.DeserializeObject<GenericRoot<AccountIntermediateData>>(jsonStr).response), num1 != 0, num2 != 0, cancellationToken);
        }
            ...
            VKRequestsDispatcher.DispatchRequestToVK<ResolvedData>("execute.resolveScreenName", new Dictionary<string, string>()
      {
      ...
      }, callback, (Func<string, ResolvedData>)null, false, true, new CancellationToken?());
        }
        ...
        public void StatusSet(string text, string audio, long groupId, Action<BackendResult<long, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<long>("status.set", parameters, callback, null, false, true, new CancellationToken?());
        }
        ...
        public void LookupContacts(string service, string myContact, List<string> contacts, Action<BackendResult<LookupContactsResponse, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<LookupContactsResponse>("account.lookupContacts", parameters, callback, null, false, true, new CancellationToken?());
        }
    }
}

...
namespace VKClient.Audio.Base.Library
{
  public class FriendsCache
  {
    ...
    public void SetFriends(List<User> friends, FriendRequests requests)
    {
      ...
      CacheManager.TrySerializeAsync((IBinarySerializable) savedContacts, this.Key, false, CacheManager.DataType.CachedData);
    }
  }
}

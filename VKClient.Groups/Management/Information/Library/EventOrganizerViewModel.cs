  ...
  public sealed class EventOrganizerViewModel : ViewModelBase
  {
    ...
    public List<CustomListPickerItem> AvailableOrganizers
    {
      ...
      set
      {
        ...
        this.NotifyPropertyChanged<List<CustomListPickerItem>>((System.Linq.Expressions.Expression<Func<List<CustomListPickerItem>>>) (() => this.AvailableOrganizers));
      }
    }
    ...
    public CustomListPickerItem Organizer
    {
      ...
      set
      {
        ...
        this.NotifyPropertyChanged<CustomListPickerItem>((System.Linq.Expressions.Expression<Func<CustomListPickerItem>>) (() => this.Organizer));
      }
    }
    ...
    public Visibility ContactsFieldsVisibility
    {
      ...
      set
      {
        ...
        this.NotifyPropertyChanged<Visibility>((System.Linq.Expressions.Expression<Func<Visibility>>) (() => this.ContactsFieldsVisibility));
        this.NotifyPropertyChanged<Visibility>((System.Linq.Expressions.Expression<Func<Visibility>>) (() => this.SetContactsButtonVisibility));
      }
    }

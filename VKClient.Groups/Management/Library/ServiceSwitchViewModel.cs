...
namespace VKClient.Groups.Management.Library
{
  public sealed class ServiceSwitchViewModel : ViewModelBase
  {
    ...
    public SolidColorBrush DisabledForeground
    {
      get
      {
        return (SolidColorBrush) Application.Current.Resources[this._currentState == CommunityServiceState.Disabled ? (object) "PhoneBlue300Brush" : (object) "PhoneContrastTitleBrush"];
      }
    }
    ...
    public SolidColorBrush OpenedForeground
    {
      get
      {
        return (SolidColorBrush) Application.Current.Resources[this._currentState == CommunityServiceState.Opened ? (object) "PhoneBlue300Brush" : (object) "PhoneContrastTitleBrush"];
      }
    }
    ...
    public SolidColorBrush LimitedForeground
    {
      get
      {
        return (SolidColorBrush) Application.Current.Resources[this._currentState == CommunityServiceState.Limited ? (object) "PhoneBlue300Brush" : (object) "PhoneContrastTitleBrush"];
      }
    }
    ...
    public SolidColorBrush ClosedForeground
    {
      get
      {
        return (SolidColorBrush) Application.Current.Resources[this._currentState == CommunityServiceState.Closed ? (object) "PhoneBlue300Brush" : (object) "PhoneContrastTitleBrush"];
      }
    }
    ...
    {
      ParametersRepository.SetParameterForId("CommunityManagementService", (object) this._service);
      ParametersRepository.SetParameterForId("CommunityManagementServiceNewState", (object) newState);

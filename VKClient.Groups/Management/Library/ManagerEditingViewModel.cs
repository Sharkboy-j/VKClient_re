...
namespace VKClient.Groups.Management.Library
{
  public sealed class ManagerEditingViewModel : ViewModelBase
  {
    ...
    public string Case
    {
      ...
      {
        if (!this._isEditing)
          return string.Format(CommonResources.WillBeCommunityManager, (object) this._manager.first_name_acc);
    ...
    public bool? IsModeratorSelected
    {
      ...
      set
      {
        ...
        this.NotifyPropertyChanged<bool?>((System.Linq.Expressions.Expression<Func<bool?>>) (() => this.IsModeratorSelected));
    ...
    public bool? IsEditorSelected
    {
      ...
      set
      {
        ...
        this.NotifyPropertyChanged<bool?>((System.Linq.Expressions.Expression<Func<bool?>>) (() => this.IsEditorSelected));
        this.NotifyPropertyChanged<bool>((System.Linq.Expressions.Expression<Func<bool>>) (() => this.IsFormCompleted));
      }
    }
    ...
    public bool? IsAdministratorSelected
    {
      ...
      set
      {
        ...
        this.NotifyPropertyChanged<bool?>((System.Linq.Expressions.Expression<Func<bool?>>) (() => this.IsAdministratorSelected));
        this.NotifyPropertyChanged<bool>((System.Linq.Expressions.Expression<Func<bool>>) (() => this.IsFormCompleted));
      }
    }
    ...
    public bool? IsContact
    {
      ...
      set
      {
        ...
        this.NotifyPropertyChanged<bool?>((System.Linq.Expressions.Expression<Func<bool?>>) (() => this.IsContact));
        this.NotifyPropertyChanged<Visibility>((System.Linq.Expressions.Expression<Func<Visibility>>) (() => this.ContactFieldsVisibility));
      }
    }
    ...
    public string Position
    {
      ...
      set
      {
        ...
        this.NotifyPropertyChanged<string>((System.Linq.Expressions.Expression<Func<string>>) (() => this.Position));
        this.NotifyPropertyChanged<double>((System.Linq.Expressions.Expression<Func<double>>) (() => this.PositionPlaceholderOpacity));
      }
    }
    ...
    public string Email
    {
      ...
      {
        this._email = value;
        this.NotifyPropertyChanged<string>((System.Linq.Expressions.Expression<Func<string>>) (() => this.Email));
        this.NotifyPropertyChanged<double>((System.Linq.Expressions.Expression<Func<double>>) (() => this.EmailPlaceholderOpacity));
      }
    }
    ...
    public string Phone
    {
      ...
      {
        this._phone = value;
        this.NotifyPropertyChanged<string>((System.Linq.Expressions.Expression<Func<string>>) (() => this.Phone));
        this.NotifyPropertyChanged<double>((System.Linq.Expressions.Expression<Func<double>>) (() => this.PhonePlaceholderOpacity));
      }
    }
    ...
    public ManagerEditingViewModel(long communityId, User manager, bool isContact, string position, string email, string phone, bool isEditing, bool fromPicker)
    {
    ...
    public void SaveChanges(bool isRemoving, NavigationService navigationService)
    {
      ...
      Action<BackendResult<int, ResultCode>> callback = (Action<BackendResult<int, ResultCode>>) (result => Execute.ExecuteOnUIThread((Action) (() =>
      {
        if (result.ResultCode == ResultCode.Succeeded)
        {
          ...
          communityManagerChanged.User = user;

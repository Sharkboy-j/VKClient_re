...
namespace VKClient.Groups.Library
{
  public class CommunitySubscribersViewModel : ViewModelBase, ICollectionDataProvider<CommunitySubscribers, LinkHeader>, IHandle<CommunityManagerChanged>, IHandle, IHandle<CommunityBlockChanged>
  {
    ...
    public void RemoveFromCommunity(LinkHeader user)
    {
      ...
      Func<LinkHeader, bool> func1 = null;
      Func<LinkHeader, bool> func2 = null;
      Func<LinkHeader, bool> func3 = null;
      Func<LinkHeader, bool> func4=null;
      GroupsService.Current.HandleRequest(this.CommunityId, user.Id, false, (Action<BackendResult<int, ResultCode>>) (result => Execute.ExecuteOnUIThread((Action) (() =>
      {
        ...
        {
          LinkHeader linkHeader1 = this.All.Collection.FirstOrDefault<LinkHeader>(func1 ?? (func1 = (Func<LinkHeader, bool>) (i => i.Id == user.Id)));
          if (linkHeader1 != null)
            this.All.Delete(linkHeader1);
          LinkHeader linkHeader2 = this.Unsure.Collection.FirstOrDefault<LinkHeader>(func2 ?? (func2 = (Func<LinkHeader, bool>) (i => i.Id == user.Id)));
          if (linkHeader2 != null)
            this.Unsure.Delete(linkHeader2);
          LinkHeader linkHeader3 = this.Friends.Collection.FirstOrDefault<LinkHeader>(func3 ?? (func3 = (Func<LinkHeader, bool>) (i => i.Id == user.Id)));
          if (linkHeader3 != null)
            this.Friends.Delete(linkHeader3);
          GenericCollectionViewModel2<VKList<User>, LinkHeader> collectionViewModel2 = this.SearchViewModel;
          if ((collectionViewModel2 != null ? collectionViewModel2.GroupedCollection : (ObservableCollection<Group<LinkHeader>>) null) != null && this.SearchViewModel.GroupedCollection.Count > 1)
          {
            LinkHeader linkHeader4 = this.SearchViewModel.GroupedCollection[1].FirstOrDefault<LinkHeader>(func4 ?? (func4 = (Func<LinkHeader, bool>) (i => i.Id == user.Id)));
            if (linkHeader4 != null)
    ...
    public void NavigateToManagerEditing(LinkHeader item)
    {
      ...
      Navigator.Current.NavigateToCommunityManagementManagerEditing(this.CommunityId, item.User, isContact, position, email, phone);
    }

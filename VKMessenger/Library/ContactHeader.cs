...
namespace VKMessenger.Library
{
  public class ContactHeader : ViewModelBase, IBinarySerializable
  {
    ...
    public BitmapImage Image
    {
      ...
      {
        this._image = value;
        this.NotifyPropertyChanged<BitmapImage>((System.Linq.Expressions.Expression<Func<BitmapImage>>) (() => this.Image));
      }
    }
    ...
    public string ContactName
    {
      ...
      set
      {
        ...
        this.NotifyPropertyChanged<string>((System.Linq.Expressions.Expression<Func<string>>) (() => this.ContactName));
      }
    }
    ...
    public string VKName
    {
      ...
      {
        this._vKName = value;
        this.NotifyPropertyChanged<string>((System.Linq.Expressions.Expression<Func<string>>) (() => this.VKName));
      }
    }
    ...
    public Visibility IsOnline
    {
      get
      {
        return this.AssignedUser != null && this.AssignedUser.online != 0 ? Visibility.Visible : Visibility.Collapsed;
      }
    }
    ...
    public User AssignedUser
    {
      ...
      set
      {
        ...
        this.NotifyPropertyChanged<User>((System.Linq.Expressions.Expression<Func<User>>) (() => this.AssignedUser));
        this.NotifyPropertyChanged<string>((System.Linq.Expressions.Expression<Func<string>>) (() => this.PhotoMedium));
    ...
    public ContactHeader(Contact contact)
    {
      ...
      if (Deployment.Current.Dispatcher.CheckAccess())
        ...
        Deployment.Current.Dispatcher.BeginInvoke((Action) (() => contactHeader.SetImage(contact)));
    }
    ...
    private void SetImageToDefaultPlaceholder()
    {
      ...
      this.Image = new BitmapImage();
      this.Image.SetSource(resourceStream.Stream);

...
namespace XamlAnimatedGif.Decompression
{
    internal class LzwDecompressStream : Stream
    {
        ...
        {
            public static LzwDecompressStream.Sequence ClearCode { get; set; }

            public static LzwDecompressStream.Sequence StopCode { get; set; }
            ...
            {
                ClearCode = new LzwDecompressStream.Sequence(true, false);
                StopCode = new LzwDecompressStream.Sequence(false, true);
